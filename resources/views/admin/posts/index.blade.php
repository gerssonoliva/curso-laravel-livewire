<x-layouts.admin>
  <div class="flex justify-between items-center mb-4">
    ...
    <a class="btn btn-blue text-xs" href="{{ route('admin.posts.create') }}">Nuevo</a>
  </div>
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center px-2">
                      <a href="{{ route('admin.posts.edit', $post) }}" class="text-xs btn btn-green">Editar</a>
                      <form action="{{ route('admin.posts.destroy', $post) }}" method="post" class="form-delete ml-2">
                        @csrf
                        @method('DELETE')
