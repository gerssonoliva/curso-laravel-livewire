<x-layouts.admin>
  <div class="flex justify-between items-center mb-4">
    ...
    <a class="btn btn-blue text-xs" href="{{ route('admin.categories.create') }}">Nuevo</a>
  </div>
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center px-2">
                      <a href="{{ route('admin.categories.edit', $category) }}" class="text-xs btn btn-green">Editar</a>
                      <form action="{{ route('admin.categories.destroy', $category) }}" method="post" class="form-delete ml-2">
                        @csrf
                        @method('DELETE')
